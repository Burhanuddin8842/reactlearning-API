    ...
    return (
        <>
            <div className={`w-full p-1`}>
                <div className="shadow relative h-[60vh] shadow-md shadow-emerald-200 hover:shadow-lg hover:scale-105" onMouseEnter={()=>setFocus(!focus)} onMouseLeave={()=>setFocus(!focus)}>
                    ...
                    <p className="text-gray-400 hover:text-gray-500 h-[30px] text-sm my-3 font-extralight cursor-pointer" onMouseEnter={()=>setDesc(!desc)} onMouseLeave={()=>setDesc(!desc)}>{
                        focus ?
